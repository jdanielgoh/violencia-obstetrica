    ...
    <div class="contenedor-vis-consulta">
        ...
        <div class="contenedor-graficos container main" id="contenedores-pictos">
            <GraficosPictos
                ...
                :picto="`picto_${afeccion_seleccionada}.svg`"
                :key="i"
                :color="afecciones.filter(d=>d[1] == afeccion_seleccionada)[0][2]"
                :cardinal="i+1"
...
import GraficosPictos from "@/components/visualizaciones/GraficosPictos.vue"
        ...
        seleccionDeAfeccion(){
            if(this.afeccion_seleccionada == "consentimiento"){
                ...
                this.circulos
                    ...
                    .style("fill", this.afecciones.filter(d=> d[1] == this.afeccion_seleccionada)[0][2])
                    console.log(this.afecciones.filter(d=> d[1] == this.afeccion_seleccionada))
            }
            else{
                this.circulos
                    .transition()
