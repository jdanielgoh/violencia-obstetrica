<template>
  <div>
    <section id="scrolly-portada">
      ...
      <div class="mapa-texto">
        ...
        <article class="container text">
          ...
          <div class="step step-1" data-step="1">
            ...
            <p>De los 514 partos, el 60% fueron partos vaginales y el 40% cesáreas.</p>
          ...
          <div class="step step-2" data-step="2">
            ...
            <p>
              Sin embargo, aclaramos que la muestra es aleatoria. No se seleccionaron mujeres que expresamente hubiesen tenido un parto traumático, sino madres que dieron a luz en Cuba y que tuvieran la disposición de responder. Partos Rotos trabajó con 13 encuestadoras que compartieron el cuestionario entre sus redes de contactos, y estas con otras mujeres hasta sobrepasar los 500 cuestionarios. Aunque puede existir una predisposición de las embarazadas que vivieron violencia a responder el cuestionario, tanto periodistas como encuestadoras eligieron libremente a quién preguntar.
            </p>
            <p>
          ...
          <div class="step step-3" data-step="3">
            <p>
              Solo el 52% confirmó que le pidieron consentimiento para todos los procedimientos que realizaron a ellas y a sus bebés durante el parto. 
          ...
          <div class="step step-6" data-step="6">
            ...
            <p>
              Un 76% de las encuestadas que tuvieron un parto vaginal afirmó que se les practicó una episiotomía. De ellas a solo el 21 % le pidieron consentimiento y al 73% no le aplicaron anestesia para cortarlas.
          ...
          <div class="step step-10" data-step="10">
            ...
            <p>
              Esto es relevante si contemplamos que la propia Revista Cubana de Obstetricia y Ginecología reconoció en<a class="link-text" href="https://www.medigraphic.com/pdfs/revcubobsgin/cog-2018/cog183b.pdf" target="_blank">
              un artículo de 2018 </a> que, dada la poca información que existe, no podía asegurarse que no haya partos humanizados, ni crueldad durante el proceso. “La insuficiencia de estudios en Cuba respecto al tema imposibilita proporcionar datos reales o aproximados del manejo del parto humanizado. Sigue siendo necesario el desarrollo de investigaciones de corte cualitativo y trabajos de campo que estimen las características de la atención”, apuntó el artículo.
      ...
      <div class="container main">
        <p>
              **Para explorar cuáles fueron las principales manifestaciones de violencia sufridas por las madres, los invitamos a interactuar con el mapa y explorar cada hospital. En la visualización también pueden analizar las secuelas psicológicas que tuvieron estas cubanas tras sus partos.
            </p>
            <p>
              **Nota: Como parte de la aplicación de este cuestionario procesamos las respuestas abiertas de las madres. Casi 200 relataron con más detalle sus experiencias durante el parto y el embarazo. Algunos fragmentos fueron utilizados en esta visualización. Si quieres leer los testimonios completos puedes pinchar en este  <router-link class="link-text" :to="{name: 'Testimonios'}" >enlace</router-link>             </p>
            <p>
              ** Si has dado a luz en Cuba y quieres compartirnos tu experiencia, puedes acceder a nuestros <router-link class="link-text" :to="{name: 'Cuestionarios'}" >cuestionarios</router-link>
            </p>
      </div>
    </section>
  </div>
